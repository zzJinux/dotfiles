# Generated by Powerlevel10k configuration wizard on 2024-03-19 at 00:33 KST.
...
# instant_prompt=verbose. (font: JetBrainsMonoNL Nerd Font)
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|ktx|knshelm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|cdk|terraform|pulumi|terragrunt|awsp'
